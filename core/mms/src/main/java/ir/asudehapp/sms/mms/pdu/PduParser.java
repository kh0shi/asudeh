    ...
    public GenericPdu parse(){
        ...
        switch (messageType) {
            case PduHeaders.MESSAGE_TYPE_SEND_REQ:
                if (LOCAL_LOGV) {
                    PduLog.v("parse: MESSAGE_TYPE_SEND_REQ");
                }
                SendReq sendReq = new SendReq(mHeaders, mBody);
                return sendReq;
            case PduHeaders.MESSAGE_TYPE_SEND_CONF:
                if (LOCAL_LOGV) {
                    PduLog.v("parse: MESSAGE_TYPE_SEND_CONF");
                }
                SendConf sendConf = new SendConf(mHeaders);
                return sendConf;
            case PduHeaders.MESSAGE_TYPE_NOTIFICATION_IND:
                if (LOCAL_LOGV) {
                    PduLog.v("parse: MESSAGE_TYPE_NOTIFICATION_IND");
                }
            ...
            case PduHeaders.MESSAGE_TYPE_NOTIFYRESP_IND:
                if (LOCAL_LOGV) {
                    PduLog.v("parse: MESSAGE_TYPE_NOTIFYRESP_IND");
                }
            ...
            case PduHeaders.MESSAGE_TYPE_RETRIEVE_CONF:
                if (LOCAL_LOGV) {
                    PduLog.v("parse: MESSAGE_TYPE_RETRIEVE_CONF");
                }
                ...
                if (ctTypeStr.equals(ContentType.MULTIPART_MIXED)
                    ...
                    PduLog.e("Unsupported ContentType: " + ctTypeStr);
                }
                return null;
            case PduHeaders.MESSAGE_TYPE_DELIVERY_IND:
                if (LOCAL_LOGV) {
                    PduLog.v("parse: MESSAGE_TYPE_DELIVERY_IND");
                }
            ...
            case PduHeaders.MESSAGE_TYPE_ACKNOWLEDGE_IND:
                if (LOCAL_LOGV) {
                    PduLog.v("parse: MESSAGE_TYPE_ACKNOWLEDGE_IND");
                }
            ...
            case PduHeaders.MESSAGE_TYPE_READ_ORIG_IND:
                if (LOCAL_LOGV) {
                    PduLog.v("parse: MESSAGE_TYPE_READ_ORIG_IND");
                }
            ...
            case PduHeaders.MESSAGE_TYPE_READ_REC_IND:
                if (LOCAL_LOGV) {
                    PduLog.v("parse: MESSAGE_TYPE_READ_REC_IND");
                }
    ...
    protected PduHeaders parseHeaders(ByteArrayInputStream pduDataStream){
        ...
        while (keepParsing && (pduDataStream.available() > 0)) {
            ...
            if ((headerField >= TEXT_MIN) && (headerField <= TEXT_MAX)) {
                ...
                if (LOCAL_LOGV) {
                    PduLog.v("TextHeader: " + new String(bVal));
                }
            ...
            switch (headerField) {
                case PduHeaders.MESSAGE_TYPE:
                {
                    ...
                    if (LOCAL_LOGV) {
                        PduLog.v("parseHeaders: messageType: " + messageType);
                    }
                    switch (messageType) {
                ...
                case PduHeaders.RESPONSE_STATUS:
                {
                    ...
                    if (LOCAL_LOGV) {
                        PduLog.v("parseHeaders: byte: " + headerField + " value: " +
                                value);
                    }
                ...
                case PduHeaders.MESSAGE_SIZE:
                {
                    try {
                        ...
                        if (LOCAL_LOGV) {
                            PduLog.v("parseHeaders: longint: " + headerField + " value: " +
                                    value);
                        }
                ...
                case PduHeaders.LIMIT:
                {
                    try {
                        ...
                        if (LOCAL_LOGV) {
                            PduLog.v("parseHeaders: int: " + headerField + " value: " +
                                    value);
                        }
                        headers.setLongInteger(value, headerField);
                    } catch(RuntimeException e) {
                ...
                case PduHeaders.CONTENT_LOCATION:
                {
                    ...
                    if (null != value) {
                        try {
                            if (LOCAL_LOGV) {
                                PduLog.v("parseHeaders: string: " + headerField + " value: " +
                                        new String(value));
                            }
                ...
                case PduHeaders.RESPONSE_TEXT:
                {
                    ...
                    if (null != value) {
                        try {
                            if (LOCAL_LOGV) {
                                PduLog.v("parseHeaders: encoded string: " + headerField
                ...
                case PduHeaders.TO:
                {
                    ...
                    if (null != value) {
                        ...
                        if (null != address) {
                            ...
                            if (LOCAL_LOGV) {
                                PduLog.v("parseHeaders: (to/cc/bcc) address: " + headerField
                                        + " value: " + str);
                            }
                ...
                case PduHeaders.REPLY_CHARGING_DEADLINE:
                {
                    ...
                    try {
                        if (LOCAL_LOGV) {
                            PduLog.v("parseHeaders: time value: " + headerField
                                    + " value: " + timeValue);
                        }
                ...
                case PduHeaders.FROM: {
                    ...
                    try {
                        if (LOCAL_LOGV) {
                            PduLog.v("parseHeaders: from address: " + headerField
                ...
                case PduHeaders.MESSAGE_CLASS: {
                    ...
                    if (LOCAL_LOGV) {
                        PduLog.v("parseHeaders: MESSAGE_CLASS: " + headerField
                                + " value: " + messageClass);
                    }
                ...
                case PduHeaders.MMS_VERSION: {
                    ...
                    try {
                        if (LOCAL_LOGV) {
                            PduLog.v("parseHeaders: MMS_VERSION: " + headerField
                                    + " value: " + version);
                        }
                ...
                case PduHeaders.PREVIOUSLY_SENT_BY: {
                    ...
                    if (null != previouslySentBy) {
                        try {
                            if (LOCAL_LOGV) {
                                PduLog.v("parseHeaders: PREVIOUSLY_SENT_BY: " + headerField
                ...
                case PduHeaders.PREVIOUSLY_SENT_DATE: {
                    ...
                    try {
                        ...
                        if (LOCAL_LOGV) {
                            PduLog.v("parseHeaders: PREVIOUSLY_SENT_DATE: " + headerField
                ...
                case PduHeaders.MM_FLAGS: {
                     ...
                     */
                    if (LOCAL_LOGV) {
                        PduLog.v("parseHeaders: MM_FLAGS: " + headerField
                ...
                {
                    if (LOCAL_LOGV) {
                        PduLog.v("parseHeaders: MBOX_TOTALS: " + headerField);
                    }
                    /* Value-length */
                    parseValueLength(pduDataStream);
                ...
                case PduHeaders.ELEMENT_DESCRIPTOR: {
                    if (LOCAL_LOGV) {
                        PduLog.v("parseHeaders: ELEMENT_DESCRIPTOR: " + headerField);
                    }
                ...
                case PduHeaders.CONTENT_TYPE: {
                    ...
                    if (null != contentType) {
                        try {
                            if (LOCAL_LOGV) {
                                PduLog.v("parseHeaders: CONTENT_TYPE: " + headerField +
                ...
                default: {
                    if (LOCAL_LOGV) {
                        PduLog.v("parseHeaders: Unknown header: " + headerField);
                    }
                    log("Unknown header");
                }
            }
    ...
    protected static void parseContentTypeParams(ByteArrayInputStream pduDataStream,
        ...
        while(0 < lastLen) {
            ...
            switch (param) {
                ...
                case PduPart.P_CHARSET:
                    ...
                    if (((firstValue > TEXT_MIN) && (firstValue < TEXT_MAX)) ||
                        ...
                        try {
                            ...
                            PduLog.e(e, Arrays.toString(charsetStr));
                ...
                default:
                    if (LOCAL_LOGV) {
                        PduLog.v("Not supported Content-Type parameter");
                    }
                if (-1 == skipWapValue(pduDataStream, lastLen)) {
                    PduLog.e("Corrupt Content-Type");
                } else {
                    lastLen = 0;
                }
                break;
        ...
        while(0 < lastLen) {
            ...
            if (header > TEXT_MAX) {
                ...
                switch (header) {
                    ...
                    default:
                        if (LOCAL_LOGV) {
                            PduLog.v("Not supported Part headers: " + header);
                        }
                    if (-1 == skipWapValue(pduDataStream, lastLen)) {
                        PduLog.e("Corrupt Part headers");
                        return false;
                    }
                    lastLen = 0;
                    break;
